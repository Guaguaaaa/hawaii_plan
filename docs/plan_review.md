# 📝 夏威夷欧胡岛 6天5晚 旅行计划 (行程审阅与修改草稿)

> 💡 **使用指南：**
> 1. 本文档与前端 WebApp 保持 1:1 数据同步。
> 2. 你可以**直接在本文档中修改任何文字、时间、地点、预算**。
> 3. 或者在想修改的项目下方添加 `> 批注：xxx` 或 `> TODO: xxx`。
> 4. 修改完成后，只需在对话框中告诉我 *“修改好了”* 或 *“请同步修改”*，我就会自动更新网站并发布上线！
...
* **时间**：2026年8月16日 (周日) — 2026年8月22日 (周六)
* **航班**：洛杉矶往返 (LAX ↔ HNL) [状态：未预订]
* **去程**：8/16 21:50 抵达 HNL 机场
* **回程**：8/21 21:00 飞离 HNL 机场，8/22 早上到达 LAX
...
* **Straub Doctors on Call (Sheraton 酒店内)**：Sheraton Waikiki 底楼，电话 `(808) 971-6000`，营业时间每天 `08:00-18:00`（Sheraton 楼下，含免费班车）
* **Kuhio Medical Clinic (Malia 酒店旁)**：`2310 Kuhio Ave, Suite 223`，电话 `(808) 924-6688`，营业时间 `08:00-17:00`（距 Malia 步行 1 分钟）
* **Doctors of Waikiki (夜间急诊)**：`120 Liliuokalani Ave #101`，电话 `(808) 922-2112`，营业时间每天 `08:00-22:00`（晚间不适推荐）
* **Urgent Care Clinic of Waikiki**：`2155 Kalakaua Ave, Suite 308`，电话 `(808) 924-3399`（提供免费出租车接送至诊所）

> 批注 / 备注区：(可在上方或此处输入你的修改意见)

---

## 🎟️ 三、强预约项目清单 (Mandatory Reservations)

1. **Hanauma Bay 恐龙湾**
   * 预约规则：提前 2 天当地时间早 7:00 抢票
   * 官方入口：`https://pros.hnl.info/hanauma-bay`
2. **Kualoa Ranch 古兰尼牧场**
   * 预约规则：建议提前 1-2 个月在官网预订 (UTV Tour / Movie Sites Tour / Jungle Adventure)
   * 官方入口：`https://www.kualoa.com/`
3. **Diamond Head 钻石山**
   * 预约规则：提前 14 天预约登顶时间
   * 官方入口：`https://gostateparks.hawaii.gov/diamondhead`
4. **Pearl Harbor 珍珠港亚利桑那号**
   * 预约规则：提前 8 周或前一天 15:00 抢票
   * 官方入口：`https://www.recreation.gov/ticket/facility/233301`
...
## 🛍️ 五、打包清单与特产必买 (Checklist & Wishlist)

* **📄 必备证件与财务**：护照、驾照原件/翻译件、银行卡、少量美金现金
* **🤿 海滩与水上装备**：Reef-Safe 环保防晒霜、泳衣/冲浪服、浮潜面镜/咬嘴、防滑涉水鞋、手机防水袋
* **👕 服饰**：夏日服装、防晒衣/薄外套 (室内空调强)、太阳镜、遮阳帽、徒步运动鞋 (钻石山)
* **🎁 纪念品必买**：
  - ABC Store 夏威夷黑皮 Hello Kitty
  - Dole 菠萝园菠萝限定 Kitty
  - Snoopy's Surf Shop 冲浪史努比周边
  - Honolulu Cookie 铁盒曲奇
  - Kona 考纳咖啡豆
...
* **酒店预订 (5晚，未预订)**：¥9,404.73 RMB
* **租车费用 (3天)**：约 $280 USD (约 ¥2,030 RMB)
* **停车费 (2晚)**：约 $95 USD (约 ¥688 RMB)
* **油费**：约 $40 USD (约 ¥290 RMB)
* **门票预估**：约 $160 USD (约 ¥1,160 RMB)
* **餐饮小吃预估**：约 $500 USD (约 ¥3,625 RMB)
* **全员总预估 (2人)**：约 **$2,372 USD** (约 **¥17,197 RMB**)
* **人均预估 (2人平摊)**：约 **$1,186 USD / 人** (约 **¥8,598 RMB / 人**)
